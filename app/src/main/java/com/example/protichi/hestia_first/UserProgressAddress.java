...
public class UserProgressAddress extends Fragment {


    private ViewPager viewPager;
    private TabLayout tabLayout;

    public UserProgressAddress() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View setView = inflater.inflate(R.layout.fragment_user_progress_address, container, false);
