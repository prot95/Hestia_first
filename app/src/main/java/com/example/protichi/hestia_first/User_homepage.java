...
public class User_homepage extends AppCompatActivity {
    ...
    {
        try {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(getApplicationContext().openFileOutput("sql.xml", Context.MODE_APPEND));
    ...
    private String readFromFile() {
        ...
        try {
            InputStream inputStream = openFileInput("sql.xml");
