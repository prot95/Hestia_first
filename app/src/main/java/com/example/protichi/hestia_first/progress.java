...
public class progress extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new UserProgressOrder(), "ORDER");
        adapter.addFragment(new UserProgressAddress(), "ADDRESS");
        adapter.addFragment(new UserProgressPayment(), "PAYMENT");
